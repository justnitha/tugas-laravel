<nav class="navbar navbar-expand navbar-light navbar-bg">
							...
							<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
								...
								<div class="list-group">
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<!-- <img src="{{ asset('static/img/avatars/avatar-5.jpg')}}" class="avatar img-fluid rounded-circle" alt="Vanessa Tucker"> -->
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											...
											<div class="col-10 ps-2">
												<div class="text-dark">Christina Masonsss</div>
                ...
                <img src="../../static/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Dosen Konoha</span>
              </a>
